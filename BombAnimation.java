   ...
   public BombAnimation(int bombFireSet) {
      ...
      switch(bombFireSet){
         case 1: loadImages(bombFilenames); // bomb
               ...
               break;
         case 2: loadImages(imgFire); // fire
               setBackground(Color.GREEN);
               break;         
         case 3: loadImages(tipUp); // 
               setBackground(Color.GREEN);
               break;
         case 4: loadImages(tipDown); // 
               setBackground(Color.GREEN);
               break;
         case 5: loadImages(tipLeft); // 
               setBackground(Color.GREEN);
               break;
         case 6: loadImages(tipRight); // 
               setBackground(Color.GREEN);
               break;
         case 7: loadImages(vert); // 
               setBackground(Color.GREEN);
               break;
         case 8: loadImages(hori); //
               setBackground(Color.GREEN);
               break;

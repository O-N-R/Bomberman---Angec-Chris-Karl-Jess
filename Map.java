...
public class Map extends JPanel{
	...
	private JLabel[][] brick = new JLabel[17][17];
	public static boolean bombOff = false;
	int[][] brickArray = new int[17][17];	
	...
	JLabel bombLabel = new JLabel(new ImageIcon(getClass().getResource("images/bombs/bomb1.png")));
	...
	public int getbrickArray(int x, int y){
		return brickArray[x][y];
	}
